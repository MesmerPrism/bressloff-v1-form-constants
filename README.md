...
The MacKay report contains generated fields, numeric diagnostics, and validation
flags only. It is a first-pass diagnostic, not a source-figure reproduction
claim.
...
comparison, source-equation Figure 5 principal-pole curve samples, and a
