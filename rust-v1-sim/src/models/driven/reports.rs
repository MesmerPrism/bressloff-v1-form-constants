...
pub(crate) struct BolelliPoleWidthComparison {
    ...
    pub(crate) generated_width_pole_convention: Option<f64>,
    pub(crate) generated_width_decay_rate: Option<f64>,
    pub(crate) generated_width_fit_r_squared: Option<f64>,
    pub(crate) generated_width_fit_points: usize,
    pub(crate) generated_width_fit_min_r_squared: f64,
