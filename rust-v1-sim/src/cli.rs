pub(crate) fn run(args: &[String]) -> Result<(), Box<dyn std::error::Error>> {
    ...
    match command {
        ...
        "bolelli-report" => crate::bolelli_report_command(&args[2..])?,
        "nicks-report" => crate::nicks_report_command(&args[2..])?,
